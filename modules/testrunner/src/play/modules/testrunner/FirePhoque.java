...
public class FirePhoque {
    ...
    public static WebClient initializeFF(BrowserVersion browserVersion){
        ...
        firephoque.getOptions().setTimeout(30000); 
	...
	java.util.logging.Logger.getLogger("com.gargoylesoftware.htmlunit").setLevel(java.util.logging.Level.OFF);
        ...
        WebClient firephoque = initializeFF(browserVersion);
           // Go!
        int maxLength = 0;
	...
	int testNr = 0;
	    ...
	    if(testNr%100==0){
        	firephoque = initializeFF(browserVersion);
